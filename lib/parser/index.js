    ...
    parse: function(input, startRule) {
      ...
      function parse_attribute() {
        ...
        if (result0 === null) {
          ...
          if (result0 !== null) {
            result0 = (function(offset, line, column, name, escape, value) {return {'name': name, 'value': {'escape': escape != "!", 'code': value.join("")} }; })(pos0.offset, pos0.line, pos0.column, result0[0], result0[1], result0[3]);
          }
          if (result0 === null) {
            pos = clone(pos0);
          }
      ...
      function parse_function_call() {
        ...
        if (result0 !== null) {
          result0 = (function(offset, line, column, output, name, args) {
        			var func = {'type': 'call', 'name': name, 'arguments': args};
        			if(output != "")
        				func.output = output;
        			return func;
        		})(pos0.offset, pos0.line, pos0.column, result0[3], result0[4], result0[6]);
        }
        if (result0 === null) {
          pos = clone(pos0);
        }
        if (result0 === null) {
                ...
                if (result3 !== null) {
                  ...
                  if (result4 !== null) {
                    ...
                    if (result5 !== null) {
                      ...
                      if (result6 !== null) {
                        result6 = (function(offset, line, column, append, var_name) {return {'to': var_name, 'append': append != ""}; })(pos2.offset, pos2.line, pos2.column, result6[2], result6[4]);
                      }
                      if (result6 === null) {
                        pos = clone(pos2);
                      }
          ...
          if (result0 !== null) {
            result0 = (function(offset, line, column, name, args, output) {
          			var func = {'type': 'call', 'name': name, 'arguments': args};
          			if(output != "")
          				func.output = output;
          			return func;
